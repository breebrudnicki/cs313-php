            ...
            <table>
                ...
                <?php foreach ($notes as $note) : ?>
                    <tr>
                        ...
                        <td>
                            <form action="<?php echo " notescontrol.php?id=$eventId "; ?>" method='post'>
                        ...
                        <td>
                            <form action="<?php echo " notescontrol.php?id=$eventId "; ?>" method='post'>
                                <input type="hidden" name="eventId" value="<?php echo $eventId; ?>" <input type='hidden' name='noteId' value='<?php echo $note[' id '];?>'>
