    ...
    <?php
        ...
        <form action="notetaskhandle.php" method="post">
            <fieldset>
                ...
                <br>
                <input type="text" name="task" id="title" size="100" required <?php if (isset($task)) { echo "value='$task'"; } ?>>
                <br>
                <label for="description">Description</label>
                <br>
                <textarea type="text" name="description" id="note" cols="100" rows="10" required>
                    <?php
